...
JavaScript as a programming language is used in two contexts:
...
(For students who took the Systems Programming course, recall the lecture on non-blocking-IO in Java (https://www.cs.bgu.ac.il/~spl211/index.php?page=Reactor.)
