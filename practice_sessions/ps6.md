...
<h2>Practical Session - Week #6 </h2>
...
<h3>Q: Why do we need to nest environments?</h3>
...
<h3>Q: Why do we use the closure environment and not the current environment when applying a closure to obtain lexical scoping? </h3>
...
<h4>How does this program work in the substitution model</h4>
...
<h4>How does it work in the environment model</h4>
...
(*)<b>Environment:</b> finite linked list of frames, where the last frame is the frame of the global environment (GE).
...
[[image:1_2.PNG|1_2.PNG]]

(*)<b>Procedure call:</b> when a closure f with parameters <code>x1...xn</code> is called with values <code>v1...vn</code>:
   (*>)
   (*) The evaluation algorithm extends the closure's env with a new frame including the mapping from <code>x1...xn</code> to <code>v1...vn</code>. 
...
<h4>Env Diagram Example 1: Recursion</h4>

[[image:2_1.PNG|2_1.PNG]]
...
<h4>Env Diagram Example 2: Definition and application</h4>

Consider another example:

[[image:3_1.PNG|3_1.PNG]]

[[image:3_2.PNG|3_2.PNG]]

<h4>Env Diagram Example 3: Definition and Let</h4>

When we encounter a "let" expression, we can convert it to a lambda expression which we already know how to handle.

[[image:4_1.PNG|4_1.PNG]]

[[image:4_2.PNG|4_2.PNG]]
...
<h4>Env Diagram Example 4: Inferring code from a diagram</h4>
...
<h3>Pair Data Structure using Closures</h3>

<h4>Env Diagram Example 4: lazy procedural pair implementation</h4>

<b>Part A:</b>

[[image:5_1.PNG|5_1.PNG]]

[[image:5_2.PNG|5_2.PNG]]
...
<h2> Adding set! to our language </h2>
