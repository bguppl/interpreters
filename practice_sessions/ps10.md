...
<img src="https://github.com/bguppl/interpreters/blob/gh-pages/practice_sessions/resources/ps10/collatz%20exmple.png" style="text-align: center" border="0" alt="\[f(n)=\begin{cases}n/2, & \text{n is even}\\3n+1&\text{n is odd}\end{cases}\]" width="214" height="50" />
