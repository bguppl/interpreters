...
בהינתן פונקציה *f* וערך *x*, נגדיר את סדרת ההרכבות העצמיות להיות {![equation](http://www.sciweavers.org/tex2img.php?eq=%257Bx%252Cf(x)%252Cf(f(x))%252Cf(f(f(x)))%252C...%257D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=)}. הסדרה
