...
![equation](http://www.sciweavers.org/tex2img.php?eq=%7Bx%25252Cf(x)%252Cf(f(x))%2Cf(f(f(x)))%2C...7D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=)

שאלה 2 – סדרת ההפעלות העצמיות
בהינתן פונקציה *f* וערך *x*, נגדיר את סדרת ההרכבות העצמיות להיות { ... , (((��)��)��) �� ,((��)��)�� ,(��)�� ,��}. הסדרה
