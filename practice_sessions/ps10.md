...
בהינתן פונקציה ![equation 1](https://render.githubusercontent.com/render/math?math=f) וערך ![equation 2](https://render.githubusercontent.com/render/math?math=x) , נגדיר את סדרת ההרכבות העצמיות להיות { ![equation 3](https://render.githubusercontent.com/render/math?math=\displaystyle\{x,f(x),f(f(x)),f(f(f(x)))...}) } . הסדרה
