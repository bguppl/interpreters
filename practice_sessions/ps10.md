...
בהינתן פונקציה ![equation 1](https://render.githubusercontent.com/render/math?math=f) וערך ![equation 2](https://render.githubusercontent.com/render/math?math=x) , נגדיר את סדרת ההרכבות העצמיות להיות ![equation 3](https://render.githubusercontent.com/render/math?math=%7Bx%2Cf(x)%2Cf(f(x))%2Cf(f(f(x)))%2C...%7D) . הסדרה
