...
השערת קולץ גורסת כי לכל ![formula1](https://render.githubusercontent.com/render/math?math=n>1) מתקיים כי הסדרה  n,f(n), ... תמיד מתכנסת ב-1. למשל עבור ![formula3](https://render.githubusercontent.com/render/math?math=n=563): 
