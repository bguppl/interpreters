...
בהינתן פונקציה ![equation1](http://www.sciweavers.org/tex2img.php?eq=f&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=) וערך ![equation2](http://www.sciweavers.org/tex2img.php?eq=x&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=), נגדיר את סדרת ההרכבות העצמיות להיות {![equation3](http://www.sciweavers.org/tex2img.php?eq=%257Bx%252Cf(x)%252Cf(f(x))%252Cf(f(f(x)))%252C...%257D&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=)}. הסדרה
יכולה להיות סופית, או אינסופית. נרצה לייצר את הרשימה העצלה שאיבריה הם איברי הסדרה. הרשימה תיגמר כאשר
הגיעה לנקודת שבת, כלומר כאשר הערך המוחזר מהפעלת ![equation4](http://www.sciweavers.org/tex2img.php?eq=f&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=) הוא אותו הערך שעליו ![equation5](http://www.sciweavers.org/tex2img.php?eq=f&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=) הופעלה.
